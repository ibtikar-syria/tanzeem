...
namespace Tanzeem.Migrations
{
    ...
    [Migration("20250206161748_ClosureTables")]
    partial class ClosureTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tanzeem.Assignments.Assignment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Tanzeem.Assignments.AssignmentUser", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Tanzeem.Teams.Team", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Tanzeem.Teams.TeamClosure", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<Guid>("ChildTeamId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ChildTeamId");

                    b.HasIndex("TeamId");

                    b.ToTable("TeamClosures");
                });

            modelBuilder.Entity("Tanzeem.Teams.TeamUser", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Tanzeem.Teams.TeamUserClosure", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Tanzeem.Assignments.AssignmentUser", b =>
                {
                    b.HasOne("Tanzeem.Assignments.Assignment", "Assignment")
            ...
            modelBuilder.Entity("Tanzeem.Teams.Team", b =>
                {
                    b.HasOne("Tanzeem.Teams.Team", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Tanzeem.Teams.TeamClosure", b =>
                {
                    b.HasOne("Tanzeem.Teams.Team", "ChildTeam")
                        .WithMany()
                        .HasForeignKey("ChildTeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tanzeem.Teams.Team", "Team")
                        .WithMany()
                        .HasForeignKey("TeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ChildTeam");
